...
const TaskCard = ({
  ...
  return (
    <div className='bg-white rounded-xl py-4 shadow-md shadow-gray-100 border border-x-gray-200/50 cursor-pointer' onClick={onClick}>
        ...
        <div className={`px-4 border-l-[3px] ${
            ...
            <p className='text-[13px] text-gray-700/80 font-medium mt-2 mb-2 leading-[18px]'>
                ...
                <span className='font-semibold text-gray-700'>
                    {completedTodoCount}/{ totalTasks-1 }
                </span>
            </p>
            <Progress progres={progress} status={status}/>
        </div>
        <div className='px-4'> 
            <div className='flex items-center justify-between my-1'>
                <div>
                    ...
                    <p className='text-[13px] font-medium text-gray-900'>
                        {
                            moment(createdAt).format("Do MMM YYY")
                        }
                    </p>
                </div>
                <div>
